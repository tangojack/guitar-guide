...
Url_model = ['http://www.cs.brown.edu/~pff/latent/voc-release4.tgz'];
Url_cascade = ['http://people.cs.uchicago.edu/~rbg/star-cascade/voc-release4-star-cascade.tgz'];
...
!mv code/pff_code/voc-release4/* code/pff_code
!rm -r code/pff_code/voc-release4
